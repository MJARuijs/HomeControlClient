 ...
 *
 */
public class PulseAnimator extends RelativeLayout {
    ...
    private static final int DEFAULT_COLOR = Color.rgb(34, 65, 109);
     ...
     *                theme, resources, etc.
     */
    public PulseAnimator(Context context) {
        this(context, null, 0);
    }
     ...
     */
    public PulseAnimator(Context context, AttributeSet attrs) {
     ...
     *                     for defaults.
     */
    public PulseAnimator(Context context, AttributeSet attrs, int defStyleAttr) {
