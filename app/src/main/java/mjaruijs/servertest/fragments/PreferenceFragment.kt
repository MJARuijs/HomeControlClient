...
class PreferenceFragment : android.preference.PreferenceFragment() {
    ...
    private fun setPreferenceListeners() {
        ...
        findPreference("light_on").onPreferenceChangeListener = preferenceChangeListener
    ...
    private fun refreshSwitches() {
        ...
        (findPreference(Settings.KEYS.LIGHT_ON.id) as SwitchPreference).isChecked = settings!!.light
    }
